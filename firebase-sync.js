...
const groups={customers:"customers",accounts:"accounts",payments:"payments",expenses:"expenses",reminderHistory:"reminderHistory"};
...
function combinedSnapshot(){
  ...
  return {customers:mapValues("customers"),accounts:mapValues("accounts"),payments:mapValues("payments"),expenses:mapValues("expenses"),reminderLog};
}
...
function desiredGroups(data){
  return {
    customers:data.customers||[],accounts:data.accounts||[],payments:data.payments||[],expenses:data.expenses||[],reminderHistory:data.reminderHistory||[]
  };
}
